...
This plot represents the average number of rats per dollar made in 2020 by median income for each borough of New York City. In this plot we can see that the proportion of rats to median income was highest in Brooklyn and lowest in Staten Island. 